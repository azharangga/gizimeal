        ...
        <div className="mx-auto grid max-w-[1240px] items-center gap-10 px-4 py-14 sm:px-6 sm:py-20 md:grid-cols-12 md:gap-12 md:py-28">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-muted-foreground sm:text-base md:mt-6 md:text-[17px]">
              ...
              <Link href="/referensi" className="font-semibold text-foreground underline underline-offset-2 hover:text-primary">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Button asChild size="lg" variant="outline">
                <Link href="/referensi">Lihat Sumber referensi</Link>
              </Button>
            </div>
      ...
      <section className="border-b border-border bg-secondary/40">
        <div className="mx-auto max-w-[1240px] px-4 py-4 sm:px-6">
          <p className="text-center text-xs text-muted-foreground">
            ...
            <Link href="/referensi" className="underline underline-offset-2 hover:text-foreground">Lihat referensi</Link>
          </p>
        </div>
      </section>
                ...
                {[
                  ...
                  <motion.div key={title} initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.4, delay: i * 0.05 }} className="bg-background p-5 sm:p-7">
                    ...
                    <Link href={to} className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-foreground hover:text-primary">
                      Pelajari modul <ArrowUpRight className="h-3 w-3" />
                    </Link>
                  </motion.div>
                ))}
              </div>
      ...
      <section className="border-y border-border bg-[var(--surface-alt)]">
        <div className="mx-auto max-w-[1240px] px-4 py-14 sm:px-6 sm:py-20 md:py-28">
          ...
          <ol className="mt-12 grid gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-4">
            {[
              { step: "01", title: "Unggah Bahan", body: "Unggah foto bahan mentah dari dapur Anda." },
              { step: "02", title: "Deteksi Otomatis", body: "Model klasifikasi memberi label dan skor akurasi." },
              { step: "03", title: "Rekomendasi menu", body: "Sistem menyusun menu berbasis komposisi gizi." },
        ...
        <div className="mx-auto max-w-[1240px] px-4 py-14 sm:px-6 sm:py-20 md:py-28">
          <div className="grid gap-12 md:grid-cols-12">
            <div className="md:col-span-5">
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                Setiap angka, kebutuhan kalori harian, batas asupan gula, garam, dan lemak, hingga komposisi menu, merujuk langsung pada peraturan Kementerian Kesehatan dan publikasi ilmiah yang dapat Anda verifikasi sendiri.
              </p>
              <div className="mt-6">
                <Button asChild variant="outline">
                  <Link href="/referensi"><ScrollText className="mr-1.5 h-4 w-4" />Lihat semua referensi</Link>
                </Button>
              </div>
            </div>
            <div className="md:col-span-7">
              <ul className="space-y-3">
                {[
                  { code: "Permenkes No. 28 Tahun 2019", body: "Acuan Angka Kecukupan Gizi (AKG) yang dianjurkan untuk masyarakat Indonesia per kelompok usia." },
                  { code: "Permenkes No. 41 Tahun 2014", body: "Pedoman Gizi Seimbang, prinsip empat pilar dan komposisi piring makanku." },
                  { code: "WHO Healthy Diet (2020)", body: "Rekomendasi internasional untuk asupan energi, lemak jenuh, dan natrium." },
                  { code: "Mifflin–St Jeor (1990)", body: "Persamaan estimasi BMR yang digunakan pada Kalkulator Kebutuhan Kalori GiziMeal." },
      ...
      <section className="border-t border-border overflow-hidden bg-secondary/40">
        ...
        <div className="relative pb-14 sm:pb-20 md:pb-24">
          ...
          <div className="mb-5 flex animate-marquee-left gap-5">
            {[...testimonials, ...testimonials].map((t, i) => (<TestimonialCard key={`row1-${i}`} {...t} />))}
          </div>
          <div className="flex animate-marquee-right gap-5">
            {[...testimonials2, ...testimonials2].map((t, i) => (<TestimonialCard key={`row2-${i}`} {...t} />))}
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-border bg-secondary/60">
        <div className="mx-auto max-w-[1240px] px-4 py-14 text-center sm:px-6 sm:py-20 md:py-24">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm text-muted-foreground">
            Unggah satu foto bahan dan dapatkan klasifikasi, estimasi kalori, serta menu gizi seimbang dalam hitungan detik, semua dengan referensi yang dapat ditelusuri.
          </p>
...
function HeroCTA() {
  ...
  return isAuthenticated ? (
    <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-[var(--primary-hover)]">
      <Link href="/predict">Mulai Deteksi Bahan <ArrowRight className="ml-1.5 h-4 w-4" /></Link>
    </Button>
  ) : (
    <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-[var(--primary-hover)]">
  ...
  return (
    <div className="relative">
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-[0_1px_0_oklch(1_0_0/.8)_inset,0_24px_48px_-24px_oklch(0.22_0.015_230/.22)]">
        <Image src={heroIngredients} alt="Bahan makanan segar" width={1024} height={1024} className="block aspect-square w-full object-cover" priority />
      </div>
    </div>
  );
}
...
const testimonials = [
  { name: "Rina S.", role: "Ibu rumah tangga, Bandung", quote: "Sekarang saya tahu kandungan gizi dari bahan yang biasa saya masak. Rekomendasi menunya juga praktis.", rating: 5 },
  { name: "Dimas P.", role: "Mahasiswa Gizi", quote: "Cocok untuk belajar AKG dan komposisi pangan tanpa harus buka tabel satu per satu.", rating: 4 },
  { name: "Sari W.", role: "Pekerja kantoran", quote: "Kalkulator kalorinya jelas dan saran menunya seimbang. Membantu saya menjaga pola makan.", rating: 5 },
  { name: "Budi H.", role: "Personal trainer, Jakarta", quote: "Klien saya jadi lebih paham soal porsi dan kebutuhan gizi harian mereka. Sangat membantu edukasi.", rating: 5 },
  { name: "Anisa R.", role: "Guru PAUD, Yogyakarta", quote: "Saya pakai untuk menyusun menu makan siang anak-anak di sekolah. Simpel dan informatif.", rating: 4 },
];

const testimonials2 = [
  { name: "Fajar M.", role: "Koki rumahan, Surabaya", quote: "Tinggal foto bahan di kulkas, langsung dapat ide menu lengkap dengan info gizinya. Keren!", rating: 5 },
  { name: "Lina K.", role: "Dietisien, Semarang", quote: "Referensi ilmiahnya bisa ditelusuri. Cocok untuk edukasi pasien tentang gizi seimbang.", rating: 4 },
  { name: "Andi T.", role: "Mahasiswa Kedokteran", quote: "Fitur chatbot-nya membantu saya memahami pedoman gizi dengan bahasa yang mudah dicerna.", rating: 3 },
  { name: "Maya D.", role: "Ibu muda, Medan", quote: "Akhirnya ada platform yang bantu saya tahu apakah menu harian keluarga sudah cukup gizinya.", rating: 5 },
  { name: "Reza A.", role: "Atlet renang", quote: "Saya bisa pantau asupan kalori dan protein harian dengan mudah. Sangat berguna untuk performa.", rating: 4 },
];
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 rounded-2xl border border-border bg-card p-6 sm:p-8">
      ...
      <div>
        ...
        <textarea id="contact-message" rows={4} placeholder="Tulis pesan kamu di sini..." required className="w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring" />
      </div>
