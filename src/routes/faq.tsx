  ...
  head: () => ({
    meta: [
      { title: "Pertanyaan Umum - GiziMeal" },
      {
        name: "description",
        content:
          "Jawaban atas pertanyaan yang sering diajukan tentang GiziMeal: cara kerja deteksi bahan, kalkulator AKG, sumber data, dan batasan layanan.",
      },
      { property: "og:title", content: "Pertanyaan Umum, GiziMeal" },
      {
        property: "og:description",
        content:
          "Pelajari cara kerja deteksi bahan, kalkulator gizi, sumber data, dan batasan layanan GiziMeal.",
      },
    ],
  }),
});
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Button asChild size="sm">
                    <Link to="/chatbot">Tanya Asisten</Link>
                  </Button>
