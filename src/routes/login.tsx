...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Masuk ke akun GiziMeal untuk mengakses fitur deteksi bahan dan rekomendasi menu gizi seimbang.",
      },
    ],
  }),
});
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      toast("Fitur lupa password segera hadir", {
                        description: "Hubungi admin untuk reset password.",
                      })
                    }
