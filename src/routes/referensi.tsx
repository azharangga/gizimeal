...
export const Route = createFileRoute("/referensi")({
  ...
  head: () => ({
    meta: [
      { title: "Referensi & Sumber Ilmiah - GiziMeal" },
      {
        name: "description",
        content:
          "Daftar peraturan, pedoman Kemenkes RI, dan referensi ilmiah yang menjadi dasar perhitungan kalori, kebutuhan gizi, dan rekomendasi menu di GiziMeal.",
      },
    ],
  }),
});
